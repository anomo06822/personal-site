...
export const siteConfig: SiteConfig = {
  ...
  siteDescription: {
    "zh-TW":
      "Jarvis Huang 的個人經歷與技術筆記站，聚焦平台架構、後端工程與工程交付。",
    en: "Jarvis Huang's bilingual personal experience and technical writing site for platform engineering and delivery.",
  },
  navigation: {
    "zh-TW": [
      ...
      { key: "resume", label: "個人經歷", description: "Experience" },
    ...
    en: [
      ...
      { key: "resume", label: "Personal Experience", description: "Experience" },
...
export const siteCopy = {
  "zh-TW": {
    ...
    resume: {
      ...
      featuredTitle: "代表成果",
      cloudCertificationsTitle: "雲端證照",
      cloudCertificationsIntro:
        "集中列出 Azure 與 Google Cloud 相關證照，只保留可對外驗證的官方公開連結。",
      cloudCertificationsVerifyLabel: "查看官方驗證",
      cloudCertificationsIssuedLabel: "取得日期",
      cloudCertificationsExpiresLabel: "到期日",
      cloudCertificationsIssuerLabel: "發證單位",
      cloudCertificationsCredentialIdLabel: "Credential ID",
      cloudCertificationsNoteLabel: "補充說明",
      cloudCertificationsActiveLabel: "有效",
      cloudCertificationsExpiredLabel: "已過期",
      cloudCertificationsNoExpiryLabel: "未提供到期日",
      evidenceTitle: "個人活躍程度",
      evidenceIntro:
        "把 GitHub 與 LeetCode 的公開紀錄集中在頁尾，補充最近一段時間的實作與練習活躍度。",
      evidenceGeneratedLabel: "資料更新",
      evidenceUnavailableTitle: "資料暫時無法顯示",
      evidenceUnavailableBody:
        "如果 build 時外部資料來源失敗，這個區塊會保留版面但不阻擋整站輸出。",
      githubEvidenceTitle: "GitHub 活動熱區",
      githubEvidenceBody:
        "用最近一年的 contribution heatmap 與近期活躍 repository，補足個人經歷頁上的公開實作訊號。",
      githubEvidenceCtaLabel: "前往 GitHub",
      githubEvidenceTotalLabel: "近一年 contributions",
      githubEvidenceRecentReposLabel: "近期活躍 repo",
      githubEvidenceNoReposLabel: "目前沒有可顯示的近期公開 repo。",
      githubEvidenceLegendLowLabel: "少",
      githubEvidenceLegendHighLabel: "多",
      leetcodeEvidenceTitle: "LeetCode 練習紀錄",
      leetcodeEvidenceBody:
        "保留題量、難度分布與活躍天數，作為演算法練習節奏的補充訊號。",
      leetcodeEvidenceCtaLabel: "前往 LeetCode",
      leetcodeEvidenceSolvedLabel: "已解題數",
      leetcodeEvidenceRankingLabel: "目前排名",
      leetcodeEvidenceReputationLabel: "Reputation",
      leetcodeEvidenceStreakLabel: "目前 streak",
      leetcodeEvidenceActiveDaysLabel: "總活躍天數",
      leetcodeEvidenceContestLabel: "Contest rating",
      leetcodeEvidenceDifficultyLabel: "難度分布",
      leetcodeEvidenceMissingLabel:
        "尚未設定 LeetCode 使用者名稱，這個區塊目前保留位置但不顯示資料。",
      leetcodeEvidenceUnavailableLabel: "LeetCode 公開資料目前暫時無法抓取。",
      showcaseTitle: "專案介紹 / Project Showcase",
      showcaseIntro:
        "把自己主導的個人作品與曾參與的核心產品分開呈現，避免公開版個人經歷把 ownership 與 collaboration 混在一起。",
      ...
      personalProjectsIntro:
        "個人經歷頁先保留快速導覽，完整的個人專案列表與入口集中在上方的「專案」頁面。",
      personalProjectsCtaLabel: "查看全部個人專案",
      coreProductsTitle: "Core Products",
      coreProductsIntro:
        "以下保留曾參與交付與營運的核心產品摘要，作為公開版個人經歷的工作脈絡。",
    ...
    blog: {
      ...
      attachmentsTitle: "附件下載",
      attachmentsBody: "如果文章附帶 deck、範本或補充檔案，會集中放在這裡。",
      attachmentDownloadLabel: "下載附件",
      endCtaTitle: "下一步閱讀",
  ...
  en: {
    home: {
      ...
      intro:
        "A focused public profile that highlights positioning, representative experience, and technical writing without turning the entry page into a duplicate personal experience page.",
      profileLinksEyebrow: "Verified Profiles",
      profileLinksTitle: "Public profile hub",
      profileLinksIntro:
        "Two public entry points for personal experience context, code history, and career visibility.",
      featuredExperienceTitle: "Selected experience",
      latestPostsTitle: "Latest writing",
      resumeCta: "View full personal experience",
    ...
    resume: {
      ...
      cloudCertificationsTitle: "Cloud Certifications",
      cloudCertificationsIntro:
        "A focused list of Azure and Google Cloud credentials that include official public verification links.",
      cloudCertificationsVerifyLabel: "Verify credential",
      cloudCertificationsIssuedLabel: "Issued",
      cloudCertificationsExpiresLabel: "Expires",
      cloudCertificationsIssuerLabel: "Issuer",
      cloudCertificationsCredentialIdLabel: "Credential ID",
      cloudCertificationsNoteLabel: "Note",
      cloudCertificationsActiveLabel: "Active",
      cloudCertificationsExpiredLabel: "Expired",
      cloudCertificationsNoExpiryLabel: "No expiry shown",
      evidenceTitle: "Personal Activity",
      evidenceIntro:
        "A compact footer section for recent GitHub and LeetCode signals, showing current build and practice activity at a glance.",
      evidenceGeneratedLabel: "Updated",
      evidenceUnavailableTitle: "Evidence is temporarily unavailable",
      evidenceUnavailableBody:
        "If an external source fails during build, the section keeps its place without blocking the rest of the site export.",
      githubEvidenceTitle: "GitHub Contribution Heatmap",
      githubEvidenceBody:
        "A one-year contribution view plus recently active repositories to keep public implementation signals close to the main story.",
      githubEvidenceCtaLabel: "Open GitHub",
      githubEvidenceTotalLabel: "Contributions in the last year",
      githubEvidenceRecentReposLabel: "Recently active repos",
      githubEvidenceNoReposLabel: "There are no recent public repositories to show right now.",
      githubEvidenceLegendLowLabel: "Less",
      githubEvidenceLegendHighLabel: "More",
      leetcodeEvidenceTitle: "LeetCode Practice Record",
      leetcodeEvidenceBody:
        "Solved volume, difficulty mix, and active-day signals stay visible here as a compact supplement to the main experience page.",
      leetcodeEvidenceCtaLabel: "Open LeetCode",
      leetcodeEvidenceSolvedLabel: "Problems solved",
      leetcodeEvidenceRankingLabel: "Current ranking",
      leetcodeEvidenceReputationLabel: "Reputation",
      leetcodeEvidenceStreakLabel: "Current streak",
      leetcodeEvidenceActiveDaysLabel: "Total active days",
      leetcodeEvidenceContestLabel: "Contest rating",
      leetcodeEvidenceDifficultyLabel: "Difficulty split",
      leetcodeEvidenceMissingLabel:
        "A LeetCode username is not configured yet, so this section keeps the layout without showing live data.",
      leetcodeEvidenceUnavailableLabel:
        "LeetCode public data could not be loaded for this build.",
      ...
      personalProjectsIntro:
        "The personal experience page keeps this section compact. The full list of personal builds now lives under the top-level Projects page.",
      ...
      projectDetailBackLabel: "Back to personal experience",
    ...
    blog: {
      ...
      attachmentsBody: "If this article ships with a deck, template, or supplemental file, it will appear here.",
